...
#
# Usage:
# sbatch experiments/update_eprop_neuron_model_exc_adapt_test/submit_sweep_slurm.sh
#
# Behavior:
...
DEFAULT_SPEC_PATH="${REPO_ROOT}/experiments/update_eprop_neuron_model_exc_adapt_test/update_eprop_neuron_model_exc_adapt_sweep.yaml"
