...
#
# Usage:
# bash experiments/epropplus_poisson_background/run_sweep_local.sh [--parallel N] [--spec SPEC_PATH]
#
# Examples:
# bash experiments/epropplus_poisson_background/run_sweep_local.sh --parallel 2
# bash experiments/epropplus_poisson_background/run_sweep_local.sh --parallel 3 --spec update_eprop_neuron_model_sweep.yaml
